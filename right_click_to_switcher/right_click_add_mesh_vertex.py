...
def draw_add_to_switcher_meshvertex(self, context):
    ...
    if op and op.bl_rna.identifier == "PAINT_OT_vertex_color_set":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"设置顶点色\"⟶Switcher", icon='PLUS').action = 'button.action_meshvertex_vertex_color_set'

    elif op and op.bl_rna.identifier == "PAINT_OT_vertex_color_smooth":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"平滑顶点色\"⟶Switcher", icon='PLUS').action = 'button.action_meshvertex_vertex_color_smooth'

    elif op and op.bl_rna.identifier == "PAINT_OT_vertex_color_dirt":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"脏旧顶点色\"⟶Switcher", icon='PLUS').action = 'button.action_meshvertex_vertex_color_dirt'

    elif op and op.bl_rna.identifier == "PAINT_OT_vertex_color_from_weight":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"来自权重的顶点色\"⟶Switcher", icon='PLUS').action = 'button.action_meshvertex_vertex_color_from_weight'

    elif op and op.bl_rna.identifier == "PAINT_OT_vertex_color_invert":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"反转\"⟶Switcher", icon='PLUS').action = 'button.action_meshvertex_vertex_color_invert'

    elif op and op.bl_rna.identifier == "PAINT_OT_vertex_color_levels":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"层级\"⟶Switcher", icon='PLUS').action = 'button.action_meshvertex_vertex_color_levels'

    elif op and op.bl_rna.identifier == "PAINT_OT_vertex_color_hsv":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"色相/饱和度/明度\"⟶Switcher", icon='PLUS').action = 'button.action_meshvertex_vertex_color_hsv'
