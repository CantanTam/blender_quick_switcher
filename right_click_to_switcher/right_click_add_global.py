...
def draw_add_to_switcher_global(self, context):
    ...
    if op and op.bl_rna.identifier in {
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"全选\"⟶Switcher", icon='EVENT_A').action = 'button.action_global_select_all'
        layout.operator("call.add_to_switcher_menu", text="\"反选\"⟶Switcher", icon='PLUS').action = 'button.action_global_select_invert'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"刷选\"⟶Switcher", icon='EVENT_C').action = 'button.action_global_select_circle'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"选择镜像\"⟶Switcher", icon='MOD_MIRROR').action = 'button.action_global_select_select_mirror'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"加选/减选(菜单)\"⟶Switcher", icon='FORCE_CHARGE').action = 'button.action_call_global_select_more_or_less_menu'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"按组选择(菜单)\"⟶Switcher", icon='PRESET').action = 'button.action_select_select_grouped'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"选择相连(菜单)\"⟶Switcher", icon='LINK_BLEND').action = 'button.action_global_select_select_linked'

    elif op and op.bl_rna.identifier == "OBJECT_OT_select_pattern":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"按名称选择\"⟶Switcher", icon='PLUS').action = 'button.action_object_select_pattern'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"选择相似(菜单)\"⟶Switcher", icon='PRESET').action = 'button.action_global_select_select_similar'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"未归组顶点\"⟶Switcher", icon='PLUS').action = 'button.action_global_selectt_select_ungrouped'

    elif op and op.bl_rna.identifier == "GPENCIL_OT_select_first":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"选择首点\"⟶Switcher", icon='PLUS').action = 'button.action_global_gpencil_select_select_first'

    elif op and op.bl_rna.identifier == "GPENCIL_OT_select_last":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"选择末点\"⟶Switcher", icon='PLUS').action = 'button.action_global_gpencil_select_select_last'

    elif op and op.bl_rna.identifier == "GREASE_PENCIL_OT_select_ends":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"起始点\"⟶Switcher", icon='PLUS').action = 'button.action_global_greasepencil_select_select_first'
        layout.operator("call.add_to_switcher_menu", text="\"结束点\"⟶Switcher", icon='PLUS').action = 'button.action_global_greasepencil_select_select_last'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"选择交替\"⟶Switcher", icon='PLUS').action = 'button.action_global_select_select_alternate'

    elif op and op.bl_rna.identifier == "TRANSFORM_OT_tosphere":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"球形化\"⟶Switcher", icon='SPHERE').action = 'button.action_global_transform_tosphere'

    elif op and op.bl_rna.identifier == "TRANSFORM_OT_shear":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"切变\"⟶Switcher", icon='PLUS').action = 'button.action_global_transform_shear'

    elif op and op.bl_rna.identifier == "TRANSFORM_OT_bend":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"弯曲\"⟶Switcher", icon='PLUS').action = 'button.action_global_transform_bend'

    elif op and op.bl_rna.identifier == "TRANSFORM_OT_push_pull":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"推/拉\"⟶Switcher", icon='PLUS').action = 'button.action_global_transform_push_pull'

    elif op and op.bl_rna.identifier == "TRANSFORM_OT_translate":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"移动纹理空间\"⟶Switcher", icon='PLUS').action = 'button.action_global_transform_translate_texturespace_true'

    elif op and op.bl_rna.identifier == "TRANSFORM_OT_resize":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"缩放纹理空间\"⟶Switcher", icon='PLUS').action = 'button.action_global_transform_resize_texturespace_true'

    elif op and op.bl_rna.identifier == "TRANSFORM_OT_vertex_warp":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"弯绕\"⟶Switcher", icon='PLUS').action = 'button.action_global_transform_vertex_warp'

    elif op and op.bl_rna.identifier == "TRANSFORM_OT_vertex_random":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"随机\"⟶Switcher", icon='PLUS').action = 'button.action_global_transform_vertex_random'

    elif op and op.bl_rna.identifier == "TRANSFORM_OT_mirror":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"交互镜像\"⟶Switcher", icon='MOD_MIRROR').action = 'button.action_global_transform_mirror'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"复制\"⟶Switcher", icon='DUPLICATE').action = 'button.action_global_duplicate_move'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"复制\"⟶Switcher", icon='COPYDOWN').action = 'button.action_global_copy'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"粘贴\"⟶Switcher", icon='PASTEDOWN').action = 'button.action_global_paste'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"隐藏选中项\"⟶Switcher", icon='EVENT_H').action = 'button.action_global_hide_view_set'
        layout.operator("call.add_to_switcher_menu", text="\"隐藏未选项\"⟶Switcher", icon='HIDE_ON').action = 'button.action_global_hide_view_set_unselected'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"显示隐藏项\"⟶Switcher", icon='HIDE_OFF').action = 'button.action_global_hide_view_clear'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"删除\"⟶Switcher", icon='EVENT_X').action = 'button.action_global_call_delete_menu'
        if bpy.context.mode == "OBJECT":
            layout.operator("call.add_to_switcher_menu", text="\"全局删除\"⟶Switcher", icon='PLUS').action = 'button.action_object_delete_global_true'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"选中项->栅格点\"⟶Switcher", icon='PLUS').action = 'button.action_global_selected_to_grid'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"选中项->游标\"⟶Switcher", icon='PLUS').action = 'button.action_global_snap_selected_to_cursor_offset_false'
        layout.operator("call.add_to_switcher_menu", text="\"选中项->游标(保持偏移)\"⟶Switcher", icon='PLUS').action = 'button.action_global_snap_selected_to_cursor_offset_true'

    elif op and op.bl_rna.identifier == "VIEW3D_OT_snap_selected_to_active":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"选中项->活动项\"⟶Switcher", icon='PLUS').action = 'button.action_global_snap_selected_to_active'
        ...
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"游标->选中项\"⟶Switcher", icon='PLUS').action = 'button.action_global_snap_cursor_to_selected'

    elif op and op.bl_rna.identifier == "VIEW3D_OT_snap_cursor_to_center":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"游标->世界原点\"⟶Switcher", icon='PLUS').action = 'button.action_global_snap_cursor_to_center'

    elif op and op.bl_rna.identifier == "VIEW3D_OT_snap_cursor_to_grid":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"游标->栅格点\"⟶Switcher", icon='PLUS').action = 'button.action_global_snap_cursor_to_grid'

    elif op and op.bl_rna.identifier == "VIEW3D_OT_snap_cursor_to_active":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"游标->活动项\"⟶Switcher", icon='PLUS').action = 'button.action_global_snap_cursor_to_active'

    elif op and op.bl_rna.identifier == "OBJECT_OT_parent_set":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"设置父级目标(菜单)\"⟶Switcher", icon='PRESET').action = 'button.action_global_set_parent_menu'

    elif op and op.bl_rna.identifier == "OBJECT_OT_parent_clear":
        layout = self.layout
        layout.separator()
        layout.operator("call.add_to_switcher_menu", text="\"清空父级(菜单)\"⟶Switcher", icon='PRESET').action = 'button.action_global_parent_clear_menu'
...
def global_select_select_similar_menu_to_switcher(self, context):
    ...
    self.layout.operator("call.add_to_switcher_menu", text="\"选择相似(菜单)\"⟶Switcher", icon='PRESET').action = 'button.action_global_select_select_similar'
...
def global_transform_menu_to_switcher(self, context):
    ...
    if not show_switcher:
        return
    self.layout.separator()
    self.layout.operator("call.add_to_switcher_menu", text="\"变换(菜单)\"⟶Switcher", icon='PRESET').action = 'button.action_global_transform'
    if bpy.context.mode == "SCULPT" and bpy.app.version >= (4, 3, 0):
        self.layout.operator("call.add_to_switcher_menu", text="\"球形化\"⟶Switcher", icon='SPHERE').action = 'button.action_global_transform_tosphere'
    if context.mode == "EDIT_GPENCIL":
        self.layout.operator("call.add_to_switcher_menu", text="\"法向缩放\"⟶Switcher", icon='PLUS').action = 'button.action_gpenciledit_transform_shrink_fatten'
...
def global_hide_show_menu_to_switcher(self, context):
    ...
    if not show_switcher:
        return
    self.layout.separator()
    self.layout.operator("call.add_to_switcher_menu", text="\"显示/隐藏(菜单)\"⟶Switcher", icon='PRESET').action = 'button.action_global_hide_show_menu'
...
def add_menu_to_switcher(self, context):
    ...
    if not show_switcher:
        return
    self.layout.separator()
    self.layout.operator("call.add_to_switcher_menu", text="\"添加(菜单)\"⟶Switcher", icon='PRESET').action = 'button.action_global_add'
...
def delete_menu_to_switcher(self, context):
    ...
    if not show_switcher:
        return
    self.layout.separator()
    self.layout.operator("call.add_to_switcher_menu", text="\"删除(菜单)\"⟶Switcher", icon='EVENT_X').action = 'button.action_global_call_delete_menu'
...
def apply_menu_to_switcher(self, context):
    ...
    if not show_switcher:
        return
    self.layout.separator()
    self.layout.operator("call.add_to_switcher_menu", text="\"应用(菜单)\"⟶Switcher", icon='PRESET').action = 'button.action_global_apply'
...
def transformorientation_menu_to_switcher(self, context):
    ...
    if not show_switcher:
        return
    self.layout.separator()
    self.layout.operator("call.add_to_switcher_menu", text="\"切换坐标系(菜单)\"⟶Switcher", icon='PRESET').action = 'button.action_switch_orientation_menu'
    self.layout.operator("call.add_to_switcher_menu", text="\"全局\"⟶Switcher", icon='ORIENTATION_GLOBAL').action = 'button.action_orientation_to_global'
    self.layout.operator("call.add_to_switcher_menu", text="\"局部\"⟶Switcher", icon='ORIENTATION_LOCAL').action = 'button.action_orientation_to_local'
    self.layout.operator("call.add_to_switcher_menu", text="\"法向\"⟶Switcher", icon='ORIENTATION_NORMAL').action = 'button.action_orientation_to_normal'
    self.layout.operator("call.add_to_switcher_menu", text="\"万向\"⟶Switcher", icon='ORIENTATION_GIMBAL').action = 'button.action_orientation_to_gimbal'
    self.layout.operator("call.add_to_switcher_menu", text="\"视图\"⟶Switcher", icon='ORIENTATION_VIEW').action = 'button.action_orientation_to_view'
...
def switchsnap_menu_to_switcher(self, context):
    ...
    if not show_switcher:
        return
    self.layout.separator()
    self.layout.operator("call.add_to_switcher_menu", text="\"切换吸附(菜单)\"⟶Switcher", icon='PRESET').action = 'button.action_switch_snap_menu'
    self.layout.operator("call.add_to_switcher_menu", text="\"开/关吸附\"⟶Switcher", icon='SNAP_ON').action = 'button.action_switch_snap_toggle'
    self.layout.operator("call.add_to_switcher_menu", text="\"增量\"⟶Switcher", icon='SNAP_INCREMENT').action = 'button.action_switch_snap_increment'
    self.layout.operator("call.add_to_switcher_menu", text="\"顶点\"⟶Switcher", icon='SNAP_VERTEX').action = 'button.action_switch_snap_vertex'
    self.layout.operator("call.add_to_switcher_menu", text="\"边\"⟶Switcher", icon='SNAP_EDGE').action = 'button.action_switch_snap_edge'
    self.layout.operator("call.add_to_switcher_menu", text="\"面投射\"⟶Switcher", icon='SNAP_FACE').action = 'button.action_switch_snap_face'
    self.layout.operator("call.add_to_switcher_menu", text="\"面最近\"⟶Switcher", icon='SNAP_FACE_NEAREST').action = 'button.action_switch_snap_face_nearest'
...
def switchproportional_menu_to_switcher(self, context):
    ...
    if not show_switcher:
        return
    self.layout.separator()
    self.layout.operator("call.add_to_switcher_menu", text="\"切换衰减编辑(菜单)\"⟶Switcher", icon='PRESET').action = 'button.action_switch_proportional_menu'
    self.layout.operator("call.add_to_switcher_menu", text="\"开/关衰减编辑\"⟶Switcher", icon='PROP_ON').action = 'button.action_switch_proportional_toggle'
    self.layout.operator("call.add_to_switcher_menu", text="\"平滑\"⟶Switcher", icon='SMOOTHCURVE').action = 'button.action_switch_proportional_smooth'
    self.layout.operator("call.add_to_switcher_menu", text="\"球体\"⟶Switcher", icon='SPHERECURVE').action = 'button.action_switch_proportional_sphere'
    self.layout.operator("call.add_to_switcher_menu", text="\"根凸\"⟶Switcher", icon='ROOTCURVE').action = 'button.action_switch_proportional_root'
    self.layout.operator("call.add_to_switcher_menu", text="\"平方反比\"⟶Switcher", icon='INVERSESQUARECURVE').action = 'button.action_switch_proportional_inverse_square'
    self.layout.operator("call.add_to_switcher_menu", text="\"锐利\"⟶Switcher", icon='SHARPCURVE').action = 'button.action_switch_proportional_sharp'
    self.layout.operator("call.add_to_switcher_menu", text="\"线性\"⟶Switcher", icon='LINCURVE').action = 'button.action_switch_proportional_linear'
    self.layout.operator("call.add_to_switcher_menu", text="\"常值\"⟶Switcher", icon='NOCURVE').action = 'button.action_switch_proportional_constant'
    self.layout.operator("call.add_to_switcher_menu", text="\"随机\"⟶Switcher", icon='RNDCURVE').action = 'button.action_switch_proportional_random'
...
def snap_menu_to_switcher(self, context):
    ...
    if not show_switcher:
        return
    self.layout.separator()
    self.layout.operator("call.add_to_switcher_menu", text="\"吸附(菜单)\"⟶Switcher", icon='PRESET').action = 'button.action_global_snap_menu'
