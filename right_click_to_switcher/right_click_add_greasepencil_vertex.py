...
def draw_add_to_switcher_greasepencilvertex(self, context):
...
def register():
    bpy.types.UI_MT_button_context_menu.append(draw_add_to_switcher_greasepencilvertex)

def unregister():
    bpy.types.UI_MT_button_context_menu.remove(draw_add_to_switcher_greasepencilvertex)
