...
class QUICK_POPUP_MENU_OT_one(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        if prefs.panel_one_col1_title.strip() != "" and (typeandmode in col1_tuples or "all" in col1_tuples):
            col1 = row.column(align=True)
        if prefs.panel_one_col2_title.strip() != "" and (typeandmode in col2_tuples or "all" in col2_tuples):
            col2 = row.column(align=True)
        if prefs.panel_one_col3_title.strip() != "" and (typeandmode in col3_tuples or "all" in col3_tuples):
            col3 = row.column(align=True)
        if prefs.panel_one_col4_title.strip() != "" and (typeandmode in col4_tuples or "all" in col4_tuples):
            col4 = row.column(align=True)
        if prefs.panel_one_col5_title.strip() != "" and (typeandmode in col5_tuples or "all" in col5_tuples):
            col5 = row.column(align=True)
        if prefs.panel_one_col6_title.strip() != "" and (typeandmode in col6_tuples or "all" in col6_tuples):
            col6 = row.column(align=True)
        if prefs.panel_one_col7_title.strip() != "" and (typeandmode in col7_tuples or "all" in col7_tuples):
            col7 = row.column(align=True)
        if prefs.panel_one_col8_title.strip() != "" and (typeandmode in col8_tuples or "all" in col8_tuples):
